...
class MLBAPI {
    ...
    static func getMLBTeams() -> [MLBTeam] {
        let mlbTeams = [
            MLBTeam(teamName: "National's", city: "Washington DC", teamLogo: "Washington_Nationals_logo", stadiumName: "National's Park", stadiumImage: "Washington_Nationals_stadium"),
            MLBTeam(teamName: "Red Sox", city: "Boston", teamLogo: "Boston_Red_Sox_logo", stadiumName: "Fenway Park", stadiumImage: "Washington_Nationals_stadium"),
